...
def main(args=None):
    ...
    parser.add_argument('--gen_img_path',help='Path to save generated images')
    ...
    for idx, data in enumerate(dataloader_val):
        ...
        with torch.no_grad():
            ...
            for k in range(annots[0].shape[0]):
                bbox = annots[0][k]
                x1 = int(bbox[0])
                y1 = int(bbox[1])
                x2 = int(bbox[2])
            ...
            cv2.imwrite(os.path.join(parser.gen_img_path,str(idx)+'.jpg'), img)
